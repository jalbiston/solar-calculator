...
// math.ceil rounds up the number.  Without it it would be a decimal
  var panelsNeeded = Math.ceil(realWattNeeds / panelOutput)
//   console.log(panelsNeeded)

  var feedback="";
  feedback += "<p>Based on your average daily use of "+Math.round(dailyUseKw) +" kWh, you will need to purchase "+ panelsNeeded+" "+ panelName+" brand solar panels to offeset 100% of your electricity bill "
  ...
  feedback +="<p> The "+panelName+" panel you selected generates about XXX watts per hour.</p>"
